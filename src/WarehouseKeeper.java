...
*Sokoban v5.0 
*WarehouseKeeper.java - Class for creating WarehouseKeeper object. Extends MapElement. -
* - Implements movement & collisions detection methods from MovableMapObject interface.
*/

public class WarehouseKeeper extends MapElement implements MovableMapElement{
	
	//Constructor - set the objects x & y coordinates
	public WarehouseKeeper(int xLocation, int yLocation) {
